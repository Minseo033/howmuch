...
> 최신 운영 배포 커밋: 8eb9952 (8/13 **6주차 운영 안정화**). Render 백엔드 + Vercel 웹 배포·운영 QA 완료. 지도 반응성·문의 답변 기능은 로컬 `main`의 `bef8933`까지 반영됐고, GitHub push와 운영 배포는 아직이다. 상세는 5-17~5-26 참조
