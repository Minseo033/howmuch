...
> 새 세션/팀원이 이 파일 하나로 상황 파악. 최종 갱신: 2026-09-08
> 9/8 로컬 코드 검수: 알림 읽음 상태 경합·dispose 후 갱신, 지도 이동 요청 누락, 추천 메뉴/가격 불일치와 출처 표시 수정. 아직 커밋·운영 배포하지 않았으며 상세는 5-45 참조.
> 운영 애플리케이션 기준 커밋: `c04c9e4`. 고미 AI 추천을 서버 검증 매장 기준으로 보완하고 Render/Vercel 운영 배포까지 완료했다. 상세는 5-44 참조
