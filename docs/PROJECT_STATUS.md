...
> 최신 main: 358b837 (8/11 **어드민 페이지 대폭 확장 + 문서 기록** — 댓글 관리·문의 관리·알림 발송 탭 + 커뮤니티 통계). **8/10~8/11 작업 전부 push 완료 → Render 자동 배포 + 웹 Vercel 재배포 완료** (어드민 페이지 라이브 새 탭 3개 확인) — 상세는 5-13·5-14 참조
