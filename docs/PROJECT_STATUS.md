...
## 5-93. 9/15 행안부 착한가격업소 공식 매장·음식 사진 대량 확장 (251곳 → 778곳, 3.1배 확장)
...
- **수집 구역 및 결과**:
  ...
  4. **기타 수도권 매장**: 156곳 보존.
  - **총 공식 사진 보유 매장**: 기존 251곳에서 **778곳**으로 527곳 순증(3.1배 확장).
- **데이터 무결성 검증**:
  - 전체 9,174개 상세 레코드 전수 대조 결과 스냅샷 결손 0건, 중복 ID 0건.
  - `StoreHoursCatalogTest.java` 및 `scripts/verify-store-hours.mjs`의 사진 최소 검증 기준치를 251건에서 770건으로 상향 조정.
