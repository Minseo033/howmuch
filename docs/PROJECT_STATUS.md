...
> **2026-09-12 영업시간 1차 보강 작업**: 서울 음식점 100곳 공식 자료 조사 → 39곳 검토 완료. 코드·근거·후속 범위는 `docs/STORE_HOURS_PILOT.md`, 복구 태그·전체 Git 백업·이전 웹 배포는 `docs/STORE_HOURS_ROLLBACK.md` 참조. 시작 기준 `fe4c441`; 운영 반영 완료 여부는 위 문서의 최신 검증 기록으로 확인한다.
