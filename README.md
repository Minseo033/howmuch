...
| ❤️ **찜 · 절약 리포트** | 찜한 매장 관리, 방문 인증 시 한국소비자원 참가격 지역 평균을 우선 적용하고 미지원 품목은 착한가격업소 실제 등록가로 보완, 월별 통계 대시보드 |
...
**External APIs** — 카카오 로그인/로컬 · Gemini AI · 기상청 단기예보 · 한국소비자원 참가격 · 공공데이터포털 착한가격업소
