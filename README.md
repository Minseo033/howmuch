...
| 이름 | 역할 | 담당 |
| --- | --- | --- |
| 김민서 | PM / Front-End | 온보딩, 홈 지도, 매장 상세, 마이페이지, 관리자, 공통 예외 화면 |
| 김다나 | Front-End | 검색, 필터, 리뷰, 방문 인증, 가격 이력 |
...
| 팀원 | 담당 화면 수 | 담당 범위 |
| --- | ---: | --- |
| 김민서 | 24개 | `1-1`~`1-5`, `2-1`, `2-4`, `5-1`, `5-A`~`5-F`, `5-I`~`5-L`, `6-1`~`6-2`, `7-1`, `7-2`, `7-5`, `7-6` |
| 김다나 | 13개 | `2-2`~`2-3`, `2-5`~`2-11`, `5-G`, `5-H`, `7-3`, `7-4` |
