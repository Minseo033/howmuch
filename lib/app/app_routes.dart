class AppRoutes {
  ...
  static const root = '/';
  static const screenCatalog = '/screen-catalog';
  ...
  static const notificationSettings = '/mypage/notification-settings';
  ...
  static const networkError = '/state/network-error';
  static const emptySearchResult = '/state/empty-search';
  static const reportDeleteConfirm = '/state/report-delete-confirm';
  static const sessionExpired = '/state/session-expired';
}
