  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Color(0xFFD9DDD2), width: 0.909),
      ),
      child: Column(
        children: [
          Container(
      ...
      child: InkWell(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: Colors.white,
            borderRadius: BorderRadius.circular(22),
            border: Border.all(color: Color(0xFFD9DDD2), width: .909),
          ),
                    ...
                    Expanded(
                      child: OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side: const BorderSide(color: Color(0xFFD9DDD2)),
                        ),
                        child: const Text(
                          '상세보기',
                          style: TextStyle(
...
class MiniProgressSteps extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const items = [
      StepData('접수 완료', 0, Color(0xFF527A6C), true),
      StepData('정보 확인 중', 1, Color(0xFFA76546), false),
      StepData('승인 대기', 2, Color(0xFFD9DDD2), false),
    ];
...
class MyReportData {
  const MyReportData({
    ...
    this.notice,
    this.actionLabel,
    this.actionColor = const Color(0xFF315F52),
