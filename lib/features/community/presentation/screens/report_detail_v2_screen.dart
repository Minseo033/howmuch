...
class ReportDetailV2Screen extends ConsumerStatefulWidget {
  ...
  static const _black = Color(0xFF0F172A);
...
class _InfoMessageCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: const EdgeInsets.all(AppSizes.horizontalPadding),
      decoration: BoxDecoration(
        color: hasNotice ? const Color(0xFFFFF3EA) : const Color(0xFFEEF2FF),
        borderRadius: BorderRadius.circular(22),
        border: Border.all(
          color: hasNotice ? const Color(0xFFFDE68A) : const Color(0xFFEFF4FF),
          width: .909,
        ),
      ),
      child: Row(
  ...
  Widget build(BuildContext context) {
    ...
    final items = [
      ...
      _StepData(
        _reviewResultLabel,
        2,
        currentIndex >= 2 ? _currentColor : const Color(0xFFE5E7EB),
        currentIndex > 2,
      ),
      _StepData(
        '지도 반영',
