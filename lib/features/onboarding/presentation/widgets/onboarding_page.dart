...
class OnboardingPage extends StatefulWidget {
  ...
  static const track = Color(0xFFE5E7EB);
      ...
      child: DecoratedBox(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color(0xFFF4F6FA), // Very soft light blue at top
              Color(0xFFF4F6FA), // Warm ivory canvas
            ],
          ),
        ),
...
class _SavingsBars extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const bars = [
      (40.0, '1주', Color(0xFFF59E0B)),
      (65.0, '2주', Color(0xFFF59E0B)),
      (50.0, '3주', Color(0xFFF59E0B)),
...
class _FigmaMapPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final park = Paint()..color = const Color(0xFFEFF4FF);
