...
class AppColors {
  ...
  // Original HowMuch brand palette. The merged component shapes and spacing
  // stay intact while color roles return to the established blue system.
  static const Color primary = Color(0xFF2563EB);
  static const Color primaryPressed = Color(0xFF1D4ED8);
  static const Color lime = Color(0xFFBFDBFE);
