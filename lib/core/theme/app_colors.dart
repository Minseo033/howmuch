...
class AppColors {
  ...
  static const Color lime = Color(0xFFF59E0B);
  static const Color cream = Color(0xFFF4F6FA);
  ...
  static const Color successLight = Color(0xFFEFF4FF);
  static const Color successSubtle = Color(0xFFFFF0E6);
  ...
  static const Color orangeTheme = Color(0xFFF97316);
  static const Color orangeLight = warningLight;
  static const Color tealLight = Color(0xFFEFF4FF);
  ...
  static const Color disabledSurface = Color(0xFFE5E7EB);
  ...
  static const Color focus = Color(0xFF10B981);
  static const Color modalScrim = Color(0x6B0F172A);
}
